                    ...
                    <div id="menu-left">
                        <div class="list-link">
                            <div class="inst-main__img">
                                <img src="/assets/img/institutions/Abraham-Baldwin-Agricultural-College-COLOR.svg" alt="">
                            </div>
                            <nav>
    ...
    <div class="container">
        <nav class="breadcrumb-wrapper">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a class="breadcrumb__link" href="#">Institutions</a></li>
