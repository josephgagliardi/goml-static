...
<main class="partner-details">
    <div class="container">
        <div class="partner-header">
            <div class="row">
                <div class="col-md-3">
                    <div class="partner-header__wapper">
                        <img class="partner-header__image" src="/assets/img/institutions/Abraham-Baldwin-Agricultural-College-COLOR.svg" alt="">
                    </div>
                    <nav>
                ...
                <div class="col-md-9">
                    ...
                    <div class="bundle-list">
                        <div class="bundle" id="list-link-2">
                            <div class="clearfix">
                                <h2 class="bundle__title float-left">Online Programs</h2>
                                <div class="float-right mt-md-2">
                                    <form class="form-search__expand">
                                        <label for="Search" class="sr-only">Search Terms</label>
                                        <input type="search" name="search" id="search" placeholder="Search">
                                        <em><i class="fas fa-search"></i></em>
                                    </form>
                                </div>
                            </div>
                            <div class="bundle__content">
                                ...
                                <button class="btn button-outline-02 btn-block list-link__btn" id="button-view">View more</button>
